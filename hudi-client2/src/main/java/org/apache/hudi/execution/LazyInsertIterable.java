...
import org.apache.hudi.client.util.LazyIterableIterator;
 ...
 * // TODO
 */
public abstract class LazyInsertIterable<T extends HoodieRecordPayload<T>, I, K, O, P>
  ...
  @Override
  protected abstract List<WriteStatus> computeNext();
