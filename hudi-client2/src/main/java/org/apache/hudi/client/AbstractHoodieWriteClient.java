...
//  private transient Timer.Context compactionTimer;
  ...
  public abstract I filterExists(I hoodieRecords, final String instantTime);

  public abstract O upsert(I hoodieRecords, final String instantTime);

  public abstract O upsertPreppedRecords(I hoodieRecords, final String instantTime);

  public abstract O insert(I hoodieRecords, final String instantTime);

  public abstract O insertPreppedRecords(I hoodieRecords, final String instantTime);

  public O bulkInsert(I hoodieRecords, final String instantTime) {
  ...
  public abstract O delete(I hoodieRecords, final String instantTime);

  public abstract O postWrite(HoodieWriteMetadata<O> result, String instantTime, HoodieTable<T, I, K, O, P> hoodieTable);
