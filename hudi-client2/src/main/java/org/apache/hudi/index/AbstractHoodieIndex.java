...
public abstract class AbstractHoodieIndex<T extends HoodieRecordPayload<T>, I, K, O, P> implements Serializable {
  ...
  public abstract P fetchRecordLocation(HoodieWriteInput<I> inputs, final HoodieEngineContext context, HoodieTable<T, I, K, O, P> hoodieTable);

  public abstract HoodieWriteInput<I> tagLocation(HoodieWriteInput<I> inputs, HoodieEngineContext context, HoodieTable<T, I, K, O, P> table);

  public abstract HoodieWriteOutput<O> updateLocation(HoodieWriteOutput<O> inputs, HoodieEngineContext context, HoodieTable<T, I, K, O, P> table);
