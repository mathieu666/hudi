 ...
 */
public abstract class WorkloadProfile<I> implements Serializable {

  /**
   * Input workload.
   */
  final HoodieWriteInput<I> taggedRecords;

  /**
   * Computed workload profile.
   */
  final HashMap<String, WorkloadStat> partitionPathStatMap;


  final WorkloadStat globalStat;

  public WorkloadProfile(HoodieWriteInput<I> taggedRecords) {
