...
public class HoodieCreateHandle<T extends HoodieRecordPayload<T>, I, K, O, P> extends HoodieWriteHandle<T, I, K, O, P> {

  private static final Logger LOG = LoggerFactory.getLogger(HoodieCreateHandle.class);

  private final HoodieStorageWriter<T, IndexedRecord> storageWriter;
