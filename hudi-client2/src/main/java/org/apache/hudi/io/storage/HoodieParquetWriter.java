...
public class HoodieParquetWriter<T extends HoodieRecordPayload<T>, R extends IndexedRecord>
    extends ParquetWriter<IndexedRecord> implements HoodieStorageWriter<T,R> {
  ...
  @Override
  public void writeAvroWithMetadata(R avroRecord, HoodieRecord<T> record) throws IOException {
    String seqId =
        HoodieRecord.generateSequenceId(instantTime, taskContextSupplier.getPartitionId(), recordIndex.getAndIncrement());
