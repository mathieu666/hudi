...
public class HoodieStorageWriterFactory {
  ...
  public static <T extends HoodieRecordPayload<T>, R extends IndexedRecord, I, K, O, P> HoodieStorageWriter<T, R> getStorageWriter(
  ...
  private static <T extends HoodieRecordPayload<T>, R extends IndexedRecord, I, K, O, P> HoodieStorageWriter<T, R> newParquetStorageWriter(
