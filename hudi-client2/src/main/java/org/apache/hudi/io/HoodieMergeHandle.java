...
public class HoodieMergeHandle<T extends HoodieRecordPayload<T>, I, K, O, P> extends HoodieWriteHandle<T, I, K, O, P> {
  ...
  private HoodieStorageWriter<T, IndexedRecord> storageWriter;
