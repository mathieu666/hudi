 ...
 */
public abstract class HoodieWriteHandle<T extends HoodieRecordPayload<T>, I, K, O, P> extends HoodieIOHandle<T, I, K, O, P> {
  ...
  protected int getPartitionId() {
    return taskContextSupplier.getPartitionId();
  }

  protected int getStageId() {
    return taskContextSupplier.getStageId();
  }

  protected long getAttemptId() {
    return taskContextSupplier.getAttempId();
  }
}
