...
public class HoodieMergeHandle<T extends HoodieRecordPayload, I, K, O, P> extends HoodieWriteHandle<T, I, K, O, P> {
  ...
  public HoodieMergeHandle(HoodieWriteConfig config, String instantTime, BaseHoodieTable<T, I, K, O, P> hoodieTable,
  ...
  private void init(String fileId, String partitionPath, HoodieBaseFile dataFileToBeMerged) {
    ...
    try {
      ...
      fileWriter = createNewFileWriter(instantTime, newFilePath, hoodieTable, config, writerSchema, taskContextSupplier);
