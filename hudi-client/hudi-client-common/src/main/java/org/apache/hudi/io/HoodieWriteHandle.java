 ...
 */
public abstract class HoodieWriteHandle<T extends HoodieRecordPayload, I, K, O, P> extends HoodieIOHandle<T, I, K, O, P> {
  ...
  public HoodieWriteHandle(HoodieWriteConfig config, String instantTime, String partitionPath,
                           String fileId, BaseHoodieTable<T, I, K, O, P> hoodieTable, TaskContextSupplier taskContextSupplier) {
  ...
  protected HoodieFileWriter createNewFileWriter(String instantTime, Path path, BaseHoodieTable<T, I, K, O, P> hoodieTable,
                                                 HoodieWriteConfig config, Schema schema, TaskContextSupplier sparkTaskContextSupplier) throws IOException {
