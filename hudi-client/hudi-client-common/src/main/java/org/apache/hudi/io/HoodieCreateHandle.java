...
public class HoodieCreateHandle<T extends HoodieRecordPayload, I, K, O, P> extends HoodieWriteHandle<T, I, K, O, P> {
  ...
  public HoodieCreateHandle(HoodieWriteConfig config, String instantTime, BaseHoodieTable<T, I, K, O, P> hoodieTable,
    ...
    try {
      ...
      this.fileWriter =
          HoodieFileWriterFactory.getFileWriter(instantTime, path, hoodieTable, config, writerSchema, this.taskContextSupplier);
    } catch (IOException e) {
