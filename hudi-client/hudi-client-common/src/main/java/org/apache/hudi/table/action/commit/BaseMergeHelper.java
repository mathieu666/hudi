 ...
 */
public abstract class BaseMergeHelper<T extends HoodieRecordPayload, I, K, O, P> {
   ...
   */
  public abstract void runMerge(HoodieTable<T, I, K, O, P> table, HoodieWriteHandle<T, I, K, O, P> upsertHandle) throws IOException;

  protected static GenericRecord transformRecordBasedOnNewSchema(GenericDatumReader<GenericRecord> gReader, GenericDatumWriter<GenericRecord> gWriter,
   ...
   */
  protected Iterator<GenericRecord> getMergingIterator(HoodieTable<T, I, K, O, P> table, HoodieWriteHandle<T, I, K, O, P> mergeHandle,
