 ...
 */
public abstract class BaseMarkerFiles implements Serializable {

  private static final Logger LOG = LogManager.getLogger(BaseMarkerFiles.class);
  ...
  public BaseMarkerFiles(FileSystem fs, String basePath, String markerFolderPath, String instantTime) {
  ...
  public BaseMarkerFiles(HoodieTable table, String instantTime) {
  ...
  protected String translateMarkerToDataPath(String markerPath) {
    ...
    return BaseMarkerFiles.stripMarkerSuffix(rPath);
  }
