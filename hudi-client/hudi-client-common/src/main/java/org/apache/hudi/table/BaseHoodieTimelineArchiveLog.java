 ...
 */
public abstract class BaseHoodieTimelineArchiveLog {
  ...
  protected abstract void deleteAnyLeftOverMarkerFiles(HoodieEngineContext context, HoodieInstant instant);
