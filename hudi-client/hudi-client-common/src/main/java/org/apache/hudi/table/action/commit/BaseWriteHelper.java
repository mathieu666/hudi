...
public abstract class BaseWriteHelper<T extends HoodieRecordPayload, I, K, O, P> {
  ...
  private I tag(I dedupedRecords, HoodieEngineContext context, HoodieTable<T, I, K, O, P> table) {
    // perform index loop up to get existing location of records
   ...
   */
  public I deduplicateRecords(I records, HoodieTable<T, I, K, O, P> table, int parallelism) {
