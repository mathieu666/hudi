...
public class SparkSavepointActionExecutor<T extends HoodieRecordPayload> extends BaseActionExecutor<T, JavaRDD<HoodieRecord<T>>, JavaRDD<HoodieKey>, JavaRDD<WriteStatus>, JavaPairRDD<HoodieKey, Option<Pair<String, String>>>,HoodieSavepointMetadata> {
  ...
  public SparkSavepointActionExecutor(HoodieSparkEngineContext context,
