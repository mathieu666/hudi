 ...
 */
public class HoodieSparkBootstrapHandle<T extends HoodieRecordPayload> extends HoodieSparkCreateHandle<T> {

  public HoodieSparkBootstrapHandle(HoodieWriteConfig config, String commitTime, HoodieTable hoodieTable,
