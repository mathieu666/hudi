...
public class TestHBaseIndex extends FunctionalTestHarness {
  ...
  public void testSimpleTagLocationAndUpdate() throws Exception {
    ...
    SparkHBaseIndex index = new SparkHBaseIndex(config);
    try (HoodieSparkWriteClient writeClient = getHoodieWriteClient(config);) {
      metaClient = HoodieTableMetaClient.reload(metaClient);
      HoodieSparkTable hoodieTable = HoodieSparkTable.create(metaClient, config, hadoopConf);
      ...
      metaClient = HoodieTableMetaClient.reload(metaClient);
      hoodieTable = HoodieSparkTable.create(metaClient, config, hadoopConf);
