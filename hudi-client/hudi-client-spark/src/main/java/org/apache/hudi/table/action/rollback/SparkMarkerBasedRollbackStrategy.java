...
public class SparkMarkerBasedRollbackStrategy<T extends HoodieRecordPayload> extends MarkerBasedRollbackStrategy<T, JavaRDD<HoodieRecord<T>>, JavaRDD<HoodieKey>, JavaRDD<WriteStatus>, JavaPairRDD<HoodieKey, Option<Pair<String, String>>>> {
  public SparkMarkerBasedRollbackStrategy(BaseHoodieTable table, HoodieEngineContext context, HoodieWriteConfig config, String instantTime) {
