...
public class SparkMergeOnReadRestoreActionExecutor<T extends HoodieRecordPayload> extends BaseRestoreActionExecutor<T, JavaRDD<HoodieRecord<T>>, JavaRDD<HoodieKey>, JavaRDD<WriteStatus>, JavaPairRDD<HoodieKey, Option<Pair<String, String>>>> {

  public SparkMergeOnReadRestoreActionExecutor(HoodieEngineContext context,
  ...
  protected HoodieRollbackMetadata rollbackInstant(HoodieInstant rollbackInstant) {
    ...
    switch (rollbackInstant.getAction()) {
      ...
      default:
        throw new IllegalArgumentException("invalid action name " + rollbackInstant.getAction());
    }
  }
}
