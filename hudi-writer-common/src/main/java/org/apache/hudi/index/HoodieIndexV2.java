...
public abstract class HoodieIndexV2<C extends HoodieEngineContext,T extends HoodieRecordPayload,
  ...
  public abstract P fetchRecordLocation(I inputs, final HoodieEngineContext<C> context, HoodieTable<T, I, K, O> hoodieTable);

  public abstract I tagLocation(I inputs, HoodieEngineContext<I> context, HoodieTable<T, I, K, O> table);

  public abstract O updateLocation(O inputs, HoodieEngineContext<C> context, HoodieTable<T, I, K, O> table);
