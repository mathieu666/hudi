 ...
 */
public class HoodieKeyLookupHandle<T extends HoodieRecordPayload, INPUT extends HoodieWriteInput, KEY extends HoodieWriteKey, OUTPUT extends HoodieWriteOutput> extends HoodieReadHandle<T, INPUT, KEY, OUTPUT> {
  ...
  public HoodieKeyLookupHandle(HoodieWriteConfig config, HoodieTable<T, INPUT, KEY, OUTPUT> hoodieTable,
