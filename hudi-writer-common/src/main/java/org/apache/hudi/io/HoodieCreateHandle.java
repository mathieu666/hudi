...
public class HoodieCreateHandle<T extends HoodieRecordPayload,I extends HoodieWriteInput, K extends HoodieWriteKey, O extends HoodieWriteOutput> extends HoodieWriteHandle<T,I,K,O> {
  ...
  public HoodieCreateHandle(HoodieWriteConfig config, String instantTime, HoodieTable<T,I,K,O> hoodieTable,
    ...
    try {
      ...
      this.storageWriter =
          HoodieStorageWriterFactory.getStorageWriter(instantTime, path, hoodieTable, config, writerSchema, this.taskContextSupplier);
    } catch (IOException e) {
