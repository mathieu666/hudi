...
public class HoodieCreateHandle<T extends HoodieRecordPayload, INPUT extends HoodieWriteInput, KEY extends HoodieWriteKey, OUTPUT extends HoodieWriteOutput> extends HoodieWriteHandle<T, INPUT, KEY, OUTPUT> {
  ...
  public HoodieCreateHandle(HoodieWriteConfig config, String instantTime, HoodieTable<T, INPUT, KEY, OUTPUT> hoodieTable,
