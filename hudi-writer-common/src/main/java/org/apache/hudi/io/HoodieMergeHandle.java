...
public class HoodieMergeHandle<T extends HoodieRecordPayload, I extends HoodieWriteInput, K extends HoodieWriteKey, O extends HoodieWriteOutput> extends HoodieWriteHandle<T,I,K,O> {
  ...
  private void init(String fileId, String partitionPath, HoodieBaseFile dataFileToBeMerged) {
    ...
    try {
      ...
      storageWriter =
          HoodieStorageWriterFactory.getStorageWriter(instantTime, newFilePath, hoodieTable, config, writerSchema, taskContextSupplier);
