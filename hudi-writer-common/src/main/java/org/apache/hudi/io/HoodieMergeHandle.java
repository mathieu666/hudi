...
public class HoodieMergeHandle<T extends HoodieRecordPayload, INPUT extends HoodieWriteInput, KEY extends HoodieWriteKey, OUTPUT extends HoodieWriteOutput> extends HoodieWriteHandle<T, INPUT, KEY, OUTPUT> {
   ...
   */
  public HoodieMergeHandle(HoodieWriteConfig config, String instantTime, HoodieTable<T, INPUT, KEY, OUTPUT> hoodieTable,
  ...
  private void init(String fileId, Iterator<HoodieRecord<T>> newRecordsItr) {
    try {
      ...
      long memoryForMerge = 1024 * 1024 * 256;
