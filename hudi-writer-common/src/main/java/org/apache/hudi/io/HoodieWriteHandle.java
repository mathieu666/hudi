 ...
 */
public abstract class HoodieWriteHandle<T extends HoodieRecordPayload, INPUT extends HoodieWriteInput, KEY extends HoodieWriteKey, OUTPUT extends HoodieWriteOutput> extends HoodieIOHandle<T, INPUT, KEY, OUTPUT> {
  ...
  public HoodieWriteHandle(HoodieWriteConfig config, String instantTime, String partitionPath,
                           String fileId, HoodieTable<T, INPUT, KEY, OUTPUT> hoodieTable, SparkTaskContextSupplier sparkTaskContextSupplier) {
