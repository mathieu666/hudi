...
import org.apache.hudi.table.SparkTaskContextSupplier;
...
public class HoodieStorageWriterFactory {
  ...
  public static <T extends HoodieRecordPayload, R extends IndexedRecord, INPUT extends HoodieWriteInput, KEY extends HoodieWriteKey, OUTPUT extends HoodieWriteOutput> HoodieStorageWriter<R> getStorageWriter(
      String instantTime, Path path, HoodieTable<T, INPUT, KEY, OUTPUT> hoodieTable, HoodieWriteConfig config, Schema schema,
  ...
  private static <T extends HoodieRecordPayload, R extends IndexedRecord, INPUT extends HoodieWriteInput, KEY extends HoodieWriteKey, OUTPUT extends HoodieWriteOutput> HoodieStorageWriter<R> newParquetStorageWriter(
      String instantTime, Path path, HoodieWriteConfig config, Schema schema, HoodieTable<T, INPUT, KEY, OUTPUT> hoodieTable,
      SparkTaskContextSupplier sparkTaskContextSupplier) throws IOException {
