...
import org.apache.hudi.common.table.timeline.*;
...
public class HoodieCommitArchiveLog {
   ...
   */
  public boolean archiveIfRequired(final Configuration jsc) throws IOException {
    try {
  ...
  private Stream<HoodieInstant> getInstantsToArchive(Configuration jsc) {
