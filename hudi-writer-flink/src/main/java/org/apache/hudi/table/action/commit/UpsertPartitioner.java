...
public class UpsertPartitioner<T extends HoodieRecordPayload<T>> implements Partitioner {
  ...
  public UpsertPartitioner(WorkloadProfile profile, HoodieEngineContext context, HoodieTable<T> table,
  ...
  public Map<String, List<SmallFile>> getSmallFilesForPartitions(List<String> partitionPaths, HoodieEngineContext context) {
    return null;
  }
