...
public abstract class CommitActionExecutor<T extends HoodieRecordPayload<T>, I extends HoodieWriteInput, K extends HoodieWriteKey, O extends HoodieWriteOutput>
    extends BaseCommitActionExecutor<T, I, K, O> {

  private static final Logger LOG = LogManager.getLogger(CommitActionExecutor.class);

  public CommitActionExecutor(HoodieEngineContext<I, O> jsc,
  ...
  protected HoodieMergeHandle getUpdateHandle(String partitionPath, String fileId, Iterator<HoodieRecord<T>> recordItr) {
    return new HoodieMergeHandle<>(config, instantTime, table, recordItr, partitionPath, fileId, sparkTaskContextSupplier);
  }
  ...
  public Iterator<List<WriteStatus>> handleInsert(String idPfx, Iterator<HoodieRecord<T>> recordItr)
    ...
    return new CopyOnWriteLazyInsertIterable<>(recordItr, config, instantTime, (HoodieTable<T, I, K, O>) table, idPfx,
