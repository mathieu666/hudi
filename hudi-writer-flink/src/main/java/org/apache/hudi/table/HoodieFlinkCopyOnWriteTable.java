...
public class HoodieFlinkCopyOnWriteTable<T extends HoodieRecordPayload> extends HoodieTable<T, HoodieWriteInput<List<HoodieRecord<T>>>,
    HoodieWriteKey<List<HoodieKey>>, HoodieWriteOutput<List<WriteStatus>>> {
  ...
  public HoodieWriteMetadata upsert(String instantTime,
    ...
    return new FlinkUpsertCommitActionExecutor(getContext(), config, this, instantTime, records).execute();
  }
