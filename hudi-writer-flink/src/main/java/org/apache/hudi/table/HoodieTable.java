...
public abstract class HoodieTable<T extends HoodieRecordPayload, I extends HoodieWriteInput, K extends HoodieWriteKey, O extends HoodieWriteOutput> implements Serializable {
  ...
  protected HoodieTable(HoodieWriteConfig config, HoodieTableMetaClient metaClient, HoodieEngineContext context) {
    ...
    this.index = new HBaseIndex(config);
  }
   ...
   */
  public abstract HoodieWriteMetadata upsert(String instantTime, I records);
   ...
   * @return HoodieWriteMetadata
   */
  public abstract HoodieWriteMetadata insert(String instantTime, I records);
   ...
   * @return HoodieWriteMetadata
   */
  public abstract HoodieWriteMetadata delete(String instantTime, K keys);
   ...
   */
  public abstract O compact(String compactionInstantTime,
