...
import org.apache.hudi.writer.client.utils.ParquetReaderIterator;
...
import org.apache.hudi.writer.io.HoodieCreateHandle;
...
import org.apache.hudi.writer.table.action.commit.UpsertCommitActionExecutor;
import org.apache.hudi.writer.table.action.commit.UpsertPreppedCommitActionExecutor;
import org.apache.hudi.writer.table.action.restore.CopyOnWriteRestoreActionExecutor;
import org.apache.hudi.writer.table.action.rollback.CopyOnWriteRollbackActionExecutor;
...
public class HoodieCopyOnWriteTable<T extends HoodieRecordPayload> extends HoodieTable<T> {
  ...
  @Override
  public HoodieWriteMetadata upsert(Configuration jsc, String instantTime, HoodieWriteInput<List<HoodieRecord<T>>> records) {
    return new UpsertCommitActionExecutor(jsc, config, this, instantTime, records).execute();
  }

  @Override
  public HoodieWriteMetadata insert(Configuration jsc, String instantTime, HoodieWriteInput<List<HoodieRecord<T>>> records) {
    // TODO
    return null;
  }

  @Override
  public HoodieWriteMetadata bulkInsert(Configuration jsc, String instantTime, HoodieWriteInput<List<HoodieRecord<T>>> records,
  ...
  @Override
  public HoodieWriteMetadata delete(Configuration jsc, String instantTime, HoodieWriteKey<List<HoodieKey>> keys) {
    // TODO
    return null;
  }
  ...
  public HoodieWriteMetadata bulkInsertPrepped(Configuration jsc, String instantTime,
                                               HoodieWriteInput<List<HoodieRecord<T>>> preppedRecords, Option<UserDefinedBulkInsertPartitioner> bulkInsertPartitioner) {
    // TODO
    return null;
  }
  ...
  @Override
  public HoodieWriteOutput<List<WriteStatus>> compact(Configuration jsc, String compactionInstantTime,
