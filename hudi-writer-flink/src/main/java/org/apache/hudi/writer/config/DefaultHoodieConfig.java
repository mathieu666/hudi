...
/**
 * Default Way to load Hoodie config through a {@link Properties}.
 */
public class DefaultHoodieConfig implements Serializable {
  ...
  public static void setDefaultOnCondition(Properties props, boolean condition, org.apache.hudi.common.config.DefaultHoodieConfig config) {
    if (condition) {
