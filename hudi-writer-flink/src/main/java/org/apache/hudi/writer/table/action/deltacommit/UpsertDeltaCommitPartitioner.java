...
import org.apache.hudi.writer.table.action.commit.SmallFile;
import org.apache.hudi.writer.table.action.commit.UpsertPartitioner;
...
public class UpsertDeltaCommitPartitioner<T extends HoodieRecordPayload<T>> extends UpsertPartitioner<T> {
  ...
  UpsertDeltaCommitPartitioner(WorkloadProfile profile, Configuration jsc, HoodieTable<T> table,
