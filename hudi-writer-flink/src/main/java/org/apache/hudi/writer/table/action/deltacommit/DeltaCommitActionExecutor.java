...
import org.apache.hudi.writer.execution.MergeOnReadLazyInsertIterable;
...
import org.apache.hudi.writer.table.action.commit.CommitActionExecutor;
...
public abstract class DeltaCommitActionExecutor<T extends HoodieRecordPayload<T>>
  ...
  public DeltaCommitActionExecutor(Configuration jsc,
  ...
  public Partitioner getUpsertPartitioner(WorkloadProfile profile) {
    ...
    mergeOnReadUpsertPartitioner = new UpsertDeltaCommitPartitioner(profile, hadoopConf, table, config);
