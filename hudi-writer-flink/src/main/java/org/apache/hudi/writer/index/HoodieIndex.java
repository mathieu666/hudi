...
import org.apache.hudi.writer.index.bloom.HoodieBloomIndex;
import org.apache.hudi.writer.index.bloom.HoodieGlobalBloomIndex;
...
public abstract class HoodieIndex<T extends HoodieRecordPayload> implements Serializable {
   ...
   */
  public abstract List<WriteStatus> updateLocation(List<WriteStatus> writeStatusRDD, Configuration hadoopConf,
                                                   HoodieTable<T> hoodieTable) throws HoodieIndexException;
