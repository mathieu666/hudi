...
public interface HoodieCompactor extends Serializable {
   ...
   */
  HoodieCompactionPlan generateCompactionPlan(Configuration hadoopConf, HoodieTable hoodieTable, HoodieWriteConfig config,
                                              String compactionCommitTime, Set<HoodieFileGroupId> fgIdsInPendingCompactions) throws IOException;

  /**
   * Execute compaction operations and report back status.
   */
  List<WriteStatus> compact(Configuration jsc, HoodieCompactionPlan compactionPlan, HoodieTable hoodieTable,
