...
package org.apache.hudi.writer.table.action.deltacommit;
...
import org.apache.hudi.writer.table.action.commit.WriteHelper;
...
public class UpsertDeltaCommitActionExecutor<T extends HoodieRecordPayload<T>>
  ...
  private HoodieWriteInput<List<HoodieRecord<T>>> inputRecordsRDD;

  public UpsertDeltaCommitActionExecutor(Configuration hadoopConf,
                                         HoodieWriteConfig config, HoodieTable table,
                                         String instantTime, HoodieWriteInput<List<HoodieRecord<T>>> inputRecordsRDD) {
  ...
  public HoodieWriteMetadata execute() {
    return WriteHelper.write(instantTime, inputRecordsRDD, hadoopConf, (HoodieTable<T>) table,
