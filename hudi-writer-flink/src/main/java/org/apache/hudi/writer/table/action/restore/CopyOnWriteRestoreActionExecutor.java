...
package org.apache.hudi.writer.table.action.restore;
...
public class CopyOnWriteRestoreActionExecutor extends BaseRestoreActionExecutor {
  ...
  public CopyOnWriteRestoreActionExecutor(Configuration hadoopConf,
                                          HoodieWriteConfig config,
                                          HoodieTable<?> table,
                                          String instantTime,
                                          String restoreInstantTime) {
    super(hadoopConf, config, table, instantTime, restoreInstantTime);
  }
