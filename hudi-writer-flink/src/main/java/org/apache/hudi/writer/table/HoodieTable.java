...
public abstract class HoodieTable<T extends HoodieRecordPayload> implements Serializable {
  ...
  public abstract HoodieWriteMetadata bulkInsert(Configuration jsc, String instantTime,
                                                 List<HoodieRecord<T>> records, Option<UserDefinedBulkInsertPartitioner> bulkInsertPartitioner);
   ...
   * @return HoodieWriteMetadata
   */
  public abstract HoodieWriteMetadata delete(Configuration jsc, String instantTime, List<HoodieKey> keys);
   ...
   */
  public abstract List<WriteStatus> compact(Configuration jsc, String compactionInstantTime,
