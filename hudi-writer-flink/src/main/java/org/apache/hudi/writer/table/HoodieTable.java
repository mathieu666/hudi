...
public abstract class HoodieTable<T extends HoodieRecordPayload> implements Serializable {
   ...
   */
  public abstract HoodieWriteMetadata upsert(Configuration jsc, String instantTime,
   ...
   * @return HoodieWriteMetadata
   */
  public abstract HoodieWriteMetadata insert(Configuration jsc, String instantTime,
                                             HoodieWriteInput<List<HoodieRecord<T>>> records);
   ...
   * @return HoodieWriteMetadata
   */
  public abstract HoodieWriteMetadata bulkInsert(Configuration jsc, String instantTime,
                                                 HoodieWriteInput<List<HoodieRecord<T>>> records, Option<UserDefinedBulkInsertPartitioner> bulkInsertPartitioner);
   ...
   * @return HoodieWriteMetadata
   */
  public abstract HoodieWriteMetadata delete(Configuration jsc, String instantTime, HoodieWriteKey<List<HoodieKey>> keys);
   ...
   */
  public abstract HoodieWriteOutput<List<WriteStatus>> compact(Configuration jsc, String compactionInstantTime,
