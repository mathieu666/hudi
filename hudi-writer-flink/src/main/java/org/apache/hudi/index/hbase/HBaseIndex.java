 ...
 */
public class HBaseIndex<T extends HoodieRecordPayload> extends HoodieIndexV2<T, HoodieWriteInput<List<HoodieRecord<T>>>, HoodieWriteOutput<List<WriteStatus>>> {
  ...
  @Override
  public HoodieWriteInput<List<HoodieRecord<T>>> fetchRecordLocation(HoodieWriteInput<List<HoodieRecord<T>>> inputs, HoodieEngineContext context, HoodieTable hoodieTable) {
    return null;
  }

  @Override
  public HoodieWriteInput<List<HoodieRecord<T>>> tagLocation(HoodieWriteInput<List<HoodieRecord<T>>> inputs, HoodieEngineContext context, HoodieTable table) {
    return null;
  }

  @Override
  public HoodieWriteOutput<List<WriteStatus>> updateLocation(HoodieWriteOutput<List<WriteStatus>> inputs, HoodieEngineContext context, HoodieTable table) {
    return null;
  }
